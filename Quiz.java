...
public class Quiz {
    public static void main(String[] args) {
        ...
        */
        ...
        int score = 0;
        System.out.println("\t¡Bienvenid@ al quiz de Mujeres&Tecnología!");
        System.out.println("\tCada respuesta correcta suma 5 puntos! Buena Suerte!");

       
        System.out.println("Pregunta 1. ¿Quién fue la hacker que escribió en 1994 Hacking the Wetware?");
        ...
        System.out.println("Pregunta 2. ¿Quién es Fuencisla Clemares?");
        ...
        System.out.println(" Pregunta 3. ¿Quién fue Hedwig Eva Maria Kiesler, conocida como Hedy Lamarr?");
        ...
        System.out.println("Pregunta 4. ¿Cómo se llamaban las principales 'mujeres ocultas' de la NASA, encargadas de los cálculos para que la misión del Apolo 11 concluyera con éxito?");
